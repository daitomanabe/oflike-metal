...
xcodebuild -project test11.xcodeproj \
  -scheme test11 \
  -configuration Debug \
  -destination "platform=macOS" \
  -derivedDataPath build/DerivedData/test11 \
...
```bash
./scripts/build_app.sh test11
./scripts/run_app.sh test11
# Metal debug
./scripts/run_app.sh test11 --metal-debug
```
