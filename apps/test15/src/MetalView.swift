...
private struct MetalViewRepresentable: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> MTKView {
        ...
        // Initialize coordinator with device and view
        coordinator.setup(device: device, view: mtkView)
...
class MetalViewCoordinator: NSObject, MTKViewDelegate, ObservableObject, MouseEventReceiver {
    ...
    func setup(device: MTLDevice, view: MTKView) {
        ...
        // Phase 3.2: Initialize renderer with device + view
        bridge?.initializeRenderer(device, view: view)
    ...
    private func updatePerformanceStats() {
        autoreleasepool {
            ...
            // Phase 11.2: Update global PerformanceStats
